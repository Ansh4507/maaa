...
import { resumeLink } from "../assets/projects";
  ...
  return (
    <section id="hero">
      <div className="flex py-12  mb-20 pb-20 h-fit flex-col md:flex-row ">
        <div className="left w-full lg:w-1/2  mb-4 lg:my-auto mx-auto">
          <motion.h1
            variants={container(0)}
            initial="hidden"
            animate="visible"
            className="text-6xl font-thin my-2"
          >
            Vivek Shaurya
          </motion.h1>
          <motion.span
          ...
          >
            <a href={resumeLink} target="_blank">
              <button className="flex text-slate-300 py-1 px-2 rounded-2xl border-4  border-slate-500 p-4 text-sm md:text-md">
                Resume
